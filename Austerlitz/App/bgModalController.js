...
austerlitzModule.factory('bgModalFactory', function ($http, $q) {
    return {
        getOrdersList: function () {
            ...
            $http.get('/Api/RulesCatalogApi/getOrdersList').success(deferred.resolve).error(deferred.reject);
            return deferred.promise;
        },
        getFormationList: function () {
            var deferred = $q.defer();
            $http.get('/Api/RulesCatalogApi/getFormationList').success(deferred.resolve).error(deferred.reject);
            return deferred.promise;
        },        
        getAdditionalOrderList: function () {
            var deferred = $q.defer();
            $http.get('/Api/RulesCatalogApi/getAdditionalOrderList').success(deferred.resolve).error(deferred.reject);
            return deferred.promise;
        },
...
austerlitzModule.controller('bgModalController', function ($scope, $modal, $log, bgModalFactory) {
    ...
    $scope.pickFromList = function (chosenList) {
        ...
        var modalInstance = $modal.open({
            templateUrl: '/Templates/bgPickListTemplate.html',
